...
class Draw2D {
    static version: number;
    public forceUpdate: bool;
    public clearBackBuffer: bool;
    ...
    public configure(params): bool;
    public destroy(): void;
    public begin(blendMode?, sortMode?): bool;
    ...
    public setBackBuffer(): bool;
    public getRenderTargetTexture(renderTargetIndex): Texture;
    public getRenderTarget(renderTargetIndex): RenderTarget;
    public setRenderTarget(renderTargetIndex): bool;
    public copyRenderTarget(renderTargetIndex): bool;
