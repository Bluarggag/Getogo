/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/canvas.ts */
...
CanvasLinearGradient.prototype = {
    version: 1,
    addColorStop: // Public API
    function addLinearColorStopFn(offset, color) {
    ...
    updateTexture: // Private API
    function updateLinearTextureFn(gd) {
...
CanvasRadialGradient.prototype = {
    version: 1,
    addColorStop: // Public API
    function addRadialColorStopFn(offset, color) {
        if(offset < 0 || offset > 1) {
            throw 'INDEX_SIZE_ERR';
        }
        function sortfunction(a, b) {
    ...
    updateTexture: // Private API
    function updateRadialTextureFn(gd) {
        var texture = this.texture;
        var stops = this.stops;
        var numStops = stops.length;
        if(this.numTextureStops !== numStops) {
...
var CanvasContext = (function () {
    ...
    CanvasContext.prototype.beginFrame = //
    // Public Turbulenz Canvas Context API
    //
    function (target, viewportRect) {
        if(this.target) {
...
var Canvas = (function () {
    function Canvas() { }
    Canvas.version = 1;
    Canvas.prototype.getContext = // Standard API
    function (contextId) {
    ...
    Canvas.prototype.toDataURL = function () {
        /* type */ if(this.width === 0 || this.height === 0) {
            return "data:,";
        }
    ...
    Canvas.prototype.setFontManager = // Turbulenz API
    function (fm) {
