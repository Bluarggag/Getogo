/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/drawprimitives.ts */
...
var DrawPrimitives = (function () {
    function DrawPrimitives() {
        ...
        this.rectTexSemanticsParameters = [
            'POSITION', 
            'TEXCOORD0'
        ];
    ...
    DrawPrimitives.create = function create(gd, shaderPath, shaderName, techniqueName) {
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/debuggingtools.ts */
        ...
        if(propertyName) {
            ...
            if(descriptor.get === undefined && descriptor.set === undefined) {
                ...
                object['__defineGetter__'].call(object, propertyName, function () {
                    /* value */ if(breakpoint.breakOnRead) {
                        debugger;
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/networklatencysimulator.ts */
...
var NetworkLatencyBehaviour = (function () {
    ...
    NetworkLatencyBehaviour.create = function create(config) {
...
var NetworkLatencySimulator = (function () {
    ...
    NetworkLatencySimulator.create = function create(behaviour) {
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/scenedebugging.ts */
...
Scene.prototype.drawLights = function sceneDrawLightsFn(gd, sm, camera) {
    ...
    if(numVisibleNodes > 0) {
        ...
        var writer = gd.beginDraw(gd.PRIMITIVE_LINES, ((24 * numPoint) + (16 * numSpot) + (24 * numFog)), [
            vformatFloat3, 
            vformatFloat3
        ], sem);
        if(writer) {
...
Scene.prototype.drawAreas = function sceneDrawAreasFn(gd, sm, camera) {
    ...
    if(areas) {
        ...
        var sem = this.getDebugSemanticsPosCol();
        var vformatFloat3 = gd.VERTEXFORMAT_FLOAT3;
        var writer = gd.beginDraw(gd.PRIMITIVE_LINES, (24 * numVisibleAreas), [
            vformatFloat3, 
            vformatFloat3
        ], sem);
        if(writer) {
...
Scene.prototype.drawPortals = function sceneDrawPortalsFn(gd, sm, camera) {
    ...
    if(areas) {
        ...
        var writer = gd.beginDraw(gd.PRIMITIVE_LINES, numVertices, [
            gd.VERTEXFORMAT_FLOAT3
        ], sem);
        if(writer) {
        ...
        writer = gd.beginDraw(gd.PRIMITIVE_LINES, numVertices, [
            gd.VERTEXFORMAT_FLOAT3
        ], sem);
        if(writer) {
            for(n = 0; n < numVisiblePortals; n += 1) {
...
Scene.prototype.drawPhysicsNodes = function sceneDrawPhysicsNodesFn(gd, sm, camera, physicsManager) {
    ...
    var sem = this.getDebugSemanticsPosCol();
    var vformatFloat3 = gd.VERTEXFORMAT_FLOAT3;
    var writer = gd.beginDraw(gd.PRIMITIVE_LINES, (24 * numNodes), [
        vformatFloat3, 
        vformatFloat3
    ], sem);
    if(writer) {
...
Scene.prototype.drawPhysicsGeometry = function sceneDrawPhysicsGeometryFn(gd, sm, camera, physicsManager) {
    ...
    if(!wireframeSemantics) {
        this.physicsWireframeSemantics = wireframeSemantics = gd.createSemantics([
            'POSITION', 
            'TEXCOORD0', 
            'TEXCOORD1'
        ]);
...
Scene.prototype.updateNormals = function updateNormalsFn(gd, scale, drawNormals, normalMaterial, drawTangents, tangentMaterial, drawBinormals, binormalMaterial) {
    ...
    var createNormalsGeometryInstance = function createNormalsGeometryInstanceFn(normalsNumVerts, material) {
        ...
        normalsGeometry.semantics = gd.createSemantics([
...
Scene.prototype.drawWireframe = function drawWireframeFn(gd, sm, camera, wireframeInfo) {
    ...
    if(numNodes) {
        ...
        if(!skinnedWireframeSemantics) {
            skinnedWireframeSemantics = gd.createSemantics([
                'POSITION', 
                'TEXCOORD0', 
                'TEXCOORD1', 
                'BLENDINDICES', 
        ...
        if(!solidWireframeSemantics) {
            solidWireframeSemantics = gd.createSemantics([
                'POSITION', 
                'TEXCOORD0', 
                'TEXCOORD1'
            ]);
...
Scene.prototype.getVisibilityMetrics = function getVisibilityMetricsFn() {
    ...
    for(n = 0; n < numLights; n += 1) {
        ...
        if(shadowMap) {
            if(lightInstance.frameVisible === shadowMap.frameVisible && shadowMap.numRenderables)// may be undefined
             {
                numShadowMaps += 1;
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/dumpindexbuffer.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/dumpshader.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/dumptexture.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/dumpvertexbuffer.ts */
