...
class AssetCache {
    ...
    public isLoading(key): bool;
    public request(key, params?): any;
...
class Camera {
    ...
    public infinite: bool;
    public parallel: bool;
    ...
    public getFrustumPoints(farPlane?): any[];
    public getFrustumFarPoints();
    public getFrustumExtents(extents, farClip): void;
...
class IndexBufferManager {
    ...
    public dynamicIndexBuffers: bool;
    ...
    public destroy(): void;
    static create(graphicsDevice: GraphicsDevice, dynamicIndexBuffers?: bool): IndexBufferManager;
}
...
class SoundManager {
    static version: number;
    public load: (path: string, uncompress?: bool, onSoundLoaded?: SoundManagerOnSoundLoadedFn) => void;
    ...
    public isSoundLoaded: (path: string) => bool;
    public isSoundMissing: (path: string) => bool;
...
class TextureManager {
    ...
    */
    public add(name, texture, internal): void;
    /**
    ...
    */
    ...
    @return {boolean}
    */
    public isArchiveLoaded(path): bool;
    /**
    ...
    */
    ...
    @return {boolean}
    */
    public isTextureLoaded(path): bool;
    /**
    ...
    @return {boolean}
    */
    public isTextureMissing(path): bool;
    /**
...
class VertexBufferManager {
    ...
    public graphicsDevice: GraphicsDevice;
    public dynamicVertexBuffers: bool;
    ...
    public destroy(): void;
    static create(graphicsDevice: GraphicsDevice, dynamicVertexBuffers?: bool): VertexBufferManager;
}
class ShaderManager {
    static version: number;
    ...
    public isShaderLoaded: (path: string) => bool;
    public isShaderMissing: (path: string) => bool;
