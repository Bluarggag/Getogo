...
class ForwardRendering {
    ...
    public lightFindVisibleRenderables(gd, lightInstance, scene): bool;
    public directionalLightsUpdateVisibleRenderables(gd): bool;
    public update(gd, camera, scene, currentTime): void;
    public destroyBuffers(): void;
    public updateBuffers(gd, deviceWidth, deviceHeight): bool;
