/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/capturegraphicsdevice.ts */
...
var CaptureGraphicsDevice = (function () {
    ...
    CaptureGraphicsDevice.prototype._addCommand = function (method, arg1, arg2, arg3, arg4, arg5) {
    ...
    CaptureGraphicsDevice.prototype._sortObjectArray = // We need to implement our own sort because of the way data is stored
    ...
    CaptureGraphicsDevice.prototype.drawIndexed = // GraphicsDevice API
    function (primitive, numIndices, first) {
        ...
        if(vertexBuffer) {
            ...
            vertexBuffer.setData = function captureVBSetData(data, offset, numVertices) {
                ...
                if(offset === 0 && numVertices === this.numVertices) {
                    self._addCommand(CaptureGraphicsCommand.setAllData, id, self._addData(data, (numVertices * this.stride), false));
                } else if(0 < numVertices) {
                    self._addCommand(CaptureGraphicsCommand.setData, id, offset, numVertices, self._addData(data, (numVertices * this.stride), false));
                }
    ...
    CaptureGraphicsDevice.prototype.createTexture = function (params) {
        ...
        if(texture) {
            ...
            texture.setData = function captureTSetData(data) {
                ...
                self._addCommand(CaptureGraphicsCommand.setAllData, id, self._addData(data, data.length, integers));
    ...
    CaptureGraphicsDevice.prototype.getFramesString = // Capture device API
    function () {
    ...
    CaptureGraphicsDevice.create = function create(gd) {
...
var PlaybackGraphicsDevice = (function () {
    ...
    PlaybackGraphicsDevice.create = function create(gd) {
