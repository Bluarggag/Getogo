/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/deferredrendering.ts */
...
var DeferredRendering = (function () {
    ...
    DeferredRendering.prototype.draw = function (gd, clearColor, drawDecalsFn, drawTransparentFn, drawDebugFn, postFXsetupFn) {
        ...
        if(gd.beginRenderTarget(this.baseRenderTarget)) {
            ...
            gd.drawArray(this.passes[this.passIndex.opaque], [
        ...
        if(gd.beginRenderTarget(this.mixRenderTarget)) {
            ...
            gd.drawArray(this.passes[this.passIndex.transparent], [
                globalTechniqueParameters
            ], 1);
    ...
    DeferredRendering.create = function create(gd, md, shaderManager, effectManager, settings) {
        ...
        dr.lightSemantics = gd.createSemantics([
            'POSITION'
        ]);
        dr.quadSemantics = gd.createSemantics([
            'POSITION', 
            'TEXCOORD0'
        ]);
        ...
        var identityUVTransform = new Float32Array([
            1, 
            0, 
            0, 
            1, 
        ...
        var deferredBlendUpdate = function deferredBlendUpdateFn() {
            /* camera */ this.frameUpdated = this.frameVisible;
            var node = this.node;
            var worldUpdate = node.worldUpdate;
            if(this.techniqueParametersUpdated !== worldUpdate) {
                this.techniqueParametersUpdated = worldUpdate;
        ...
        var deferredFlarePrepare = function deferredFlarePrepareFn(geometryInstance) {
            if(!geometryInstance.customGeometry) {
                ...
                var c10 = VMath.v3Normalize([
                    (v10 - v00), 
                    (v11 - v01), 
                    (v12 - v02)
                ]);
                var c20 = VMath.v3Normalize([
                    (v20 - v00), 
                    (v21 - v01), 
                    (v22 - v02)
                ]);
