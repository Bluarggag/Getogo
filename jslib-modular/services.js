/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/badgemanager.ts */
...
var BadgeManager = (function () {
    ...
    BadgeManager.prototype.listUserBadges = // list all badges (just queries the yaml file)
    function (callbackFn, errorCallbackFn) {
        var that = this;
        var cb = function cbFn(jsonResponse, status) {
            if(status === 200) {
                ...
                errorCallback("Badges.listUserBadges failed with status " + status + ": " + jsonResponse.msg, status, [
                    callbackFn
                ]);
            }
        };
    ...
    BadgeManager.prototype.updateUserBadgeProgress = function (badge_key, current, callbackFn, errorCallbackFn) {
        ...
        if(current && typeof current === 'number') {
            ...
            var errorCallback = errorCallbackFn || that.errorCallbackFn;
            errorCallback("Badges.updateUserBadgeProgress expects a numeric value for current", 400, [
                badge_key, 
                current, 
                callbackFn
            ]);
    ...
    BadgeManager.prototype.addUserBadge = // add a badge to a user (gets passed a badge and a current level
    // over POST, the username is taken from the environment)
    function (badge_key, current, callbackFn, errorCallbackFn) {
        var that = this;
        var cb = function cbFn(jsonResponse, status) {
            if(status === 200) {
                ...
                var errorCallback = errorCallbackFn || that.errorCallbackFn;
                errorCallback("Badges.addUserBadge failed with status " + status + ": " + jsonResponse.msg, status, [
                    badge_key, 
                    current, 
                    callbackFn
                ]);
    ...
    BadgeManager.prototype.listBadges = // list all badges (just queries the yaml file)
    function (callbackFn, errorCallbackFn) {
        var that = this;
        var cb = function cbFn(jsonResponse, status) {
            if(status === 200) {
                ...
                var errorCallback = errorCallbackFn || that.errorCallbackFn;
                errorCallback("Badges.listBadges failed with status " + status + ": " + jsonResponse.msg, status, [
                    callbackFn
                ]);
            }
        };
    ...
    BadgeManager.create = function create(requestHandler, gameSession) {
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/datasharemanager.ts */
        ...
        var dataShareJoinCallback = function dataShareJoinCallbackFn(jsonResponse, status) {
            ...
            if(status === 200) {
            ...
            } else if(status === 403)// 403 Forbidden
             {
                ...
                errorCallback("DataShare.join failed with " + "status " + status + ": " + jsonResponse.msg, status, that.join, [
                    callbackFn
                ]);
            }
        };
    ...
    DataShare.prototype.setJoinable = function (joinable, callbackFn, errorCallbackFn) {
        ...
        var dataShareSetJoinableCallback = function dataShareSetJoinableCallbackFn(jsonResponse, status) {
            ...
            if(status === 200) {
                ...
                errorCallback("DataShare.setJoinable failed with " + "status " + status + ": " + jsonResponse.msg, status, that.setJoinable, [
                    joinable, 
                    callbackFn
                ]);
            }
    ...
    DataShare.prototype.leave = function (callbackFn, errorCallbackFn) {
        ...
        var dataShareLeaveCallback = function dataShareLeaveCallbackFn(jsonResponse, status) {
            ...
            if(status === 200 || status === 403 || status === 404) {
                ...
                errorCallback("DataShare.leave failed with " + "status " + status + ": " + jsonResponse.msg, status, that.leave, [
                    callbackFn
                ]);
            }
        };
    ...
    DataShare.prototype.getKeys = function (callbackFn, errorCallbackFn) {
        ...
        var dataShareGetKeysCallback = function dataShareGetKeysCallbackFn(jsonResponse, status) {
            ...
            if(status === 200) {
                ...
                errorCallback("DataShare.getKeys failed with " + "status " + status + ": " + jsonResponse.msg, status, that.getKeys, [
                    callbackFn
                ]);
            }
        };
    ...
    DataShare.prototype.get = function (key, callbackFn, errorCallbackFn) {
        ...
        var dataShareGetCallback = function dataShareGetCallbackFn(jsonResponse, status) {
            ...
            if(status === 200) {
                ...
                errorCallback("DataShare.get failed with " + "status " + status + ": " + jsonResponse.msg, status, that.get, [
                    key, 
                    callbackFn
                ]);
            }
        ...
        var dataShareSetCallback = function dataShareSetCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                if(reason) {
                    ...
                    if(errorCallback) {
                        errorCallback("DataShare.set failed with " + "status " + status + ": " + jsonResponse.msg, status, that.set, [
                            params
                        ]);
                    }
                }
        ...
        var dataShareCompareAndSetCallback = function dataShareCompareAndSetCallbackFn(jsonResponse, status) {
            ...
            if(status === 200) {
                ...
                if(reason) {
                    ...
                    var errorCallback = params.errorCallback || that.errorCallbackFn;
                    errorCallback("DataShare.compareAndSet failed with " + "status " + status + ": " + jsonResponse.msg, status, that.compareAndSet, [
                        params
                    ]);
                }
            }
    ...
    DataShareManager.prototype.createDataShare = function (callbackFn, errorCallbackFn) {
        ...
        var createDataShareCallback = function createDataShareCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                var errorCallback = errorCallbackFn || that.errorCallbackFn;
                if(errorCallback) {
                    errorCallback("DataShareManager.createDataShare failed with " + "status " + status + ": " + jsonResponse.msg, status, that.createDataShare, [
                        callbackFn, 
                        errorCallbackFn
                    ]);
                }
    ...
    DataShareManager.prototype.findDataShares = function (params) {
        ...
        var findDataSharesCallback = function findDataSharesCallbackFn(jsonResponse, status) {
            ...
            if(status === 200) {
                ...
                errorCallback("DataShareManager.findDataShares failed with " + "status " + status + ": " + jsonResponse.msg, status, that.findDataShares, [
                    params
                ]);
            }
        };
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/gameprofilemanager.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/gamesession.ts */
...
var GameSession = (function () {
    ...
    GameSession.prototype.destroy = // callbackFn is for testing only!
    ...
    GameSession.prototype.setTeamInfo = /**
    ...
    */
    ...
    GameSession.create = function create(requestHandler, sessionCreatedFn, errorCallbackFn) {
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/leaderboardmanager.ts */
...
var LeaderboardManager = (function () {
    ...
    LeaderboardManager.prototype.getOverview = function (spec, callbackFn, errorCallbackFn) {
        ...
        var getOverviewCallback = function getOverviewCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                errorCallback("LeaderboardManager.getKeys failed with status " + status + ": " + jsonResponse.msg, status, that.getOverview, [
                    spec, 
                    callbackFn
                ]);
            }
    ...
    LeaderboardManager.prototype.getAggregates = function (spec, callbackFn, errorCallbackFn) {
        ...
        var getAggregatesCallback = function getAggregatesCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                errorCallback("LeaderboardManager.getKeys failed with status " + status + ": " + jsonResponse.msg, status, that.getAggregates, [
                    spec, 
                    callbackFn, 
                    errorCallbackFn
                ]);
    ...
    LeaderboardManager.prototype.getRaw = function (key, spec, callbackFn, errorCallbackFn) {
        ...
        var getCallback = function getCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                errorCallback("LeaderboardManager.get failed with status " + status + ": " + jsonResponse.msg, status, that.get, [
                    key, 
                    spec, 
                    callbackFn
                ]);
            ...
            if(status === 200) {
                ...
                if(newBest) {
                    ...
                    var scoreData = {
                        ...
                        gameSlug: // may be 'undefined'
                        that.gameSession.gameSlug
                    };
                ...
                errorCallback("LeaderboardManager.set failed with status " + status + ": " + jsonResponse.msg, status, that.set, [
                    key, 
                    score, 
                    callbackFn
                ]);
    ...
    LeaderboardManager.prototype.reset = // ONLY available on Local and Hub
    function (callbackFn, errorCallbackFn) {
        var errorCallback = errorCallbackFn || this.errorCallbackFn;
        if(!this.meta) {
            errorCallback("The leaderboard manager failed to initialize properly.");
        ...
        var resetCallback = function resetCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                errorCallback("LeaderboardManager.reset failed with status " + status + ": " + jsonResponse.msg, status, that.reset, [
                    callbackFn
                ]);
            }
        };
...
LeaderboardResult.prototype = {
    ...
    getPageOffset: function getPageBelowOffsetFn(type, offsetIndex, callbackFn, errorCallbackFn) {
        ...
        var newSpec = {
            ...
            friendsonly: // remeber to map to backend lowercase format!
            this.originalSpec.friendsOnly && 1 || 0
        };
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/mappingtable.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/multiplayersession.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/multiplayersessionmanager.ts */
...
var MultiPlayerSessionManager = (function () {
    ...
    MultiPlayerSessionManager.prototype.createSession = // Public API
    function (numSlots, sessionCreatedFn, errorCallbackFn) {
    ...
    MultiPlayerSessionManager.prototype.processRequest = // Helper Functions
    function (source, request, successFn, errorFn) {
        if(!errorFn) {
    ...
    MultiPlayerSessionManager.create = function create(requestHandler, gameSession) {
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/notificationsmanager.ts */
...
var NotificationsManager = (function () {
    ...
    NotificationsManager.prototype.sendInstantNotification = /*
    ...
    */
    ...
    NotificationsManager.prototype.sendDelayedNotification = /*
    ...
    */
    ...
    NotificationsManager.create = function create(requestHandler, gameSession, successCallbackFn, errorCallbackFn) {
        if(!errorCallbackFn) {
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/osdlib.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/sessiontoken.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/storemanager.ts */
...
var StoreManager = (function () {
    ...
    StoreManager.prototype.requestUserItems = function (callbackFn, errorCallbackFn) {
        ...
        var requestUserItemsCallback = function requestUserItemsCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                var errorCallback = errorCallbackFn || that.errorCallbackFn;
                if(errorCallback) {
                    errorCallback("StoreManager.requestUserItems failed with " + "status " + status + ": " + jsonResponse.msg, status, that.requestUserItems, [
                        callbackFn, 
                        errorCallbackFn
                    ]);
                }
        ...
        var dataSpec = {
            token: // replay attack token
            this.userItemsRequestToken.next(),
            gameSessionId: this.gameSessionId
        };
        this.service.request({
    ...
    StoreManager.prototype.getItems = // backwards compatibility
    function () {
    ...
    StoreManager.prototype.consume = function (key, consumeAmount, callbackFn, errorCallbackFn) {
        ...
        var consumeItemsCallback = function consumeItemsCallbackFn(jsonResponse, status) {
            if(status === 200) {
                ...
                var errorCallback = errorCallbackFn || that.errorCallbackFn;
                if(errorCallback) {
                    errorCallback("StoreManager.consume failed with status " + status + ": " + jsonResponse.msg, status, that.consume, [
                        callbackFn, 
                        errorCallbackFn
                    ]);
                }
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/turbulenzbridge.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/turbulenzservices.ts */
...
/* This file was generated from TypeScript source C:/Users/autobuild/turbulenz/engine/tslib/services/userdatamanager.ts */
